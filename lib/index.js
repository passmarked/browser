...
module.exports = exports = function(options) {
  ...
  **/
  ChromeClient.gc = function(fn) { ChromeClient.flush(fn); }
  ...
  ChromeClient.flush = function(fn) {
    ...
    CDP({
      ...
      .then((result)=>{
        ...
        // debug
        // console.log('closing ' + promises.length + ' tabs');
  ...
  **/
  ChromeClient.handlePageRequest = function(targetid, params, fn) {
    ...
    var finalCallback = _.once(function() {
      ...
      // clean out tabs that might be laying around
    ...
    CDP({
      ...
      client.on('event', function(dd) {
        ...
        if(dd && 
          ...
          console.log('-> closed target crashed');
      ...
      client.on('disconnect', function() {
        ...
        page.close(() => {
          ...
          // stop here
          callback(new Error('Closed before it started'))
