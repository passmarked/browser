  ...
  ChromePage.bootstrap = function() {
    ...
    var handleLoadCheck = async () => {
      ...
      try {
        ...
        const params = await Runtime.evaluate({
        ...
        loadStatus = ((params || {}).result || {}).value;
      ...
      // set the duration
      VARS.duration = VARS.ended.getTime() - VARS.started.getTime();
  ...
  ChromePage.emulate = function(params, fn) {
    ...
    .then(()=>{
      ...
      var metricConfig = {
        ...
        width:                params.width || options.width || 1400,
